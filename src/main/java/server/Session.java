...
public class Session extends Thread{
    ...
    public Session(Socket socket, int id, MTServer server) {
        this.socket = socket;
        this.id = id;
        this.server = server;
    }
    ...
    // Broadcast specific message to specific users
    public void broadcast(String message, ArrayList<Session> sessions, int messageType){
        // TODO: 16/02/2023 Implement this method
    }
